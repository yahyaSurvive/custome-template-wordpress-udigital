	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			if ( $this->has_children && 0 === $depth ) {
				...
				$atts['class']         = 'dropdown-toggle nav-link mx-lg-3 my-lg-0 mt-0 mt-2';
				...
				if ( $depth > 0 ) {
					...
					$atts['class'] = 'nav-link mx-lg-3 my-lg-0 mt-0 mt-2';
				}
			}
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link mx-lg-3 my-lg-0 mt-0 mt-2" title="' . esc_attr__( 'Add a menu', 'wp-bootstrap-navwalker' ) . '">' . esc_html__( 'Add a menu', 'wp-bootstrap-navwalker' ) . '</a></li>';
			$fallback_output .= '</ul>';
